          ...
          {errorStates.spotify ? (
            ...
            <>
              <div className="flex items-center gap-4 mb-4">
                <div className={`w-20 h-20 rounded-xl flex-shrink-0 ${spotify.is_playing
          ...
          <div className="space-y-4">
            {activities.map((activity, index) => (
              <div key={index} className="flex items-start gap-3">
                <div className={`w-2 h-2 rounded-full mt-2 ${activity.status === 'success' ? 'bg-[#00B894]' : 'bg-[#00CEC9]'
                  }`}></div>
                <div className="flex-1">
