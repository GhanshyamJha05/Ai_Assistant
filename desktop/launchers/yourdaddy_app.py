...
try:
    ...
    if not config_validator.validate():
        print("\nâš ï¸ Warning: Some required configurations are missing.")
...
try:
    ...
    print("âœ… Multilingual support loaded successfully")
except ImportError as e:
...
try:
    ...
    print("âœ… GUI framework loaded")
except ImportError:
    print("âŒ GUI framework not available")
...
class YourDaddyAssistant:
    ...
    def __init__(self):
        ...
        print(f"ðŸš€ YourDaddy Assistant {self.version} initialized with multilingual support")
    ...
    def setup_logging(self):
        ...
        self.logger.info(f"ðŸš€ YourDaddy Assistant started - Session: {session_id}")
    ...
    def setup_multilingual(self):
        ...
        try:
            if MultilingualSupport:
                ...
                self.logger.info("âœ… Multilingual support initialized")
                self.multilingual_enabled = True
            else:
                self.logger.warning("âš ï¸ Multilingual support not available")
    ...
    def setup_gui(self):
        ...
        try:
            ...
            self.talkback_button = ttk.Button(
                status_frame,
                text="ðŸ”Š Talkback: ON" if self.talkback_enabled else "ðŸ”‡ Talkback: OFF",
    ...
    def toggle_voice_listening(self):
        ...
        if self.voice_listening:
            ...
            self.voice_button.configure(text="â³ Stopping...")
    ...
    def toggle_talkback(self):
        ...
        if hasattr(self, 'talkback_button'):
            button_text = "ðŸ”Š Talkback: ON" if self.talkback_enabled else "ðŸ”‡ Talkback: OFF"
    ...
    def show_voice_settings(self):
        ...
        settings_window.title("ðŸŽ¤ Voice Settings")
    ...
    def show_personalization_settings(self):
        ...
        pers_window.title("âœ¨ Personalization Settings")
    ...
    def handle_voice_command(self, text: str):
        ...
        try:
            ...
            if text.startswith('[WAKE_WORD_DETECTED:'):
                ...
                if hasattr(self, 'root'):
                    self.root.after(0, lambda: self.log_output(f"ðŸŽ¤ Wake word detected: {wake_word}", "INFO"))
                    self.root.after(0, lambda: self.status_label.configure(text="Listening for command..."))
                return
            
            # Log recognized text
            if hasattr(self, 'root'):
                self.root.after(0, lambda: self.log_output(f"ðŸŽ¤ Heard: {text}", "INFO"))
        ...
        try:
            ...
            if command == 'make_call':
                if 'phone' in parameters:
                    ...
                    result = "Phone number à¤¯à¤¾ contact name à¤¨à¤¹à¥€à¤‚ à¤®à¤¿à¤²à¤¾"
                ...
                if 'song' in parameters:
                    ...
                    result = "à¤•à¥Œà¤¨ à¤¸à¤¾ song play à¤•à¤°à¤¨à¤¾ à¤¹à¥ˆ?"
                self.log_output(result)
                ...
                if 'query' in parameters:
                    ...
                    result = "Search query à¤¨à¤¹à¥€à¤‚ à¤®à¤¿à¤²à¤¾"
                    self.log_output(result)
                ...
                if self.multilingual_enabled:
                    ...
                    if language_context and language_context.detected_language == Language.HINGLISH:
                        hindi_time = f"à¤…à¤­à¥€ à¤¸à¤®à¤¯ à¤¹à¥ˆ {current_time}"
        ...
        if hasattr(self, 'language_var') and self.multilingual_enabled:
            ...
            try:
                ...
                if selected_lang == 'hindi':
                    self.status_label.configure(text="à¤¤à¥ˆà¤¯à¤¾à¤° à¤¹à¥ˆ")
                elif selected_lang == 'hinglish':
                    self.status_label.configure(text="Ready / à¤¤à¥ˆà¤¯à¤¾à¤° à¤¹à¥ˆ")
                else:
                    self.status_label.configure(text="Ready")
    ...
    def toggle_translation_mode(self):
        ...
        try:
            ...
            if self.translation_mode:
                self.translate_button.configure(text="ðŸ”„ ON")
                self.log_output("Translation mode enabled - commands will be translated")
            else:
                self.translate_button.configure(text="ðŸ”„ Translate")
    ...
    def discover_applications(self):
        ...
        try:
            ...
            from ai_assistant.automation.app_discovery import discover_applications
...
def main():
    """Main entry point"""
    print("=" * 60)
    print("ðŸ¤– YourDaddy Assistant - Starting...")
    print("=" * 60)
    ...
    try:
        ...
        print(f"âŒ Failed to start assistant: {e}")
        try:
            import tkinter as tk
            from tkinter import messagebox
            root = tk.Tk()
    ...
    print("\nðŸ‘‹ YourDaddy Assistant - Goodbye!")
